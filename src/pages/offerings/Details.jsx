            ...
            {itemsToShow.map((foodItem) => (
              <SwiperSlide key={foodItem.id}>
                ...
                >
                  ...
                  <div className="col-3" style={{justifyContent:"flex-start",alignItems:"",display:"flex",flexDirection:"column"}}>
                    <div className="painted-heading-new"><h2 style={{position:"relative",color:"#FF7953",top:-30}}>MILLET</h2></div>
                  ...
                  <div className="col-3" style={{justifyContent:"flex-start",alignItems:"",display:"flex",flexDirection:"column"}}>
                    <>
                      ...
                      <p style={{minHeight:"3rem",maxHeight:"5rem",padding:"3px",overflowY:"auto"}}>{foodItem.description}</p>
                    </>
                  </div>
                  <div className="col-1"></div>
                </div>
